...
from mejor_equipo_ronda import mejor_ronda
from imprimir_tabla import mostrar_tabla
from procesar import procesar_evaluaciones 
...
# Ejecutar punto 3: procesar todas las rondas y mostrar tabla final
resumen_final = procesar_evaluaciones(evaluaciones)
